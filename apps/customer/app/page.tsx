...
export default function Page() {
  ...
  const HeroImage = () => (
    <div className="relative">
      ...
      <div className="absolute bottom-3 left-3 right-3 rounded-2xl border border-white/70 bg-white/92 p-3 shadow-xl backdrop-blur md:bottom-5 md:left-6 md:right-auto md:w-[340px] md:rounded-3xl md:p-4">
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#fffaf5] text-[#0f172a]">
      <section className="relative border-b border-orange-100 bg-[radial-gradient(circle_at_top_left,#ffedd5_0,#fffaf5_34%,#ffffff_100%)]">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-12 pt-10 sm:px-6 sm:pb-16 sm:pt-12 md:px-8 lg:pb-20">
          {/* MOBILE HERO */}
